...
class CodeGenerator: CodeGen {
    ...
    private func handleProblem(faceName: String) -> String? {
        ...
        let problems = ["Al-Khalil", "Damascus", "KohinoorTelugu", "Mshtakan", "Muna", "NanumGothic", "NanumMyeongjo", "Raanana", "Skia-", "STSongti-SC-", "STSongti-TC-", "STYuanti-SC-", "STYuanti-TC-", "Waseem", ]
    ...
    private func handleProblem(fontName: String) -> String? {
        ...
        if fontName.starts(with: "YuMincho +36p Kana") {
            return fontName.replacingOccurrences(of: "YuMincho +36p Kana", with: "YuMinchoKana")
        }
